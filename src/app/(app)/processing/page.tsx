...
export default function ProcessingPage() {
  return (
    <PageContainer>
      <PageHeader title="Processing Workflows" description="Manage batch processing, drying, curing, and packaging.">
        <Button>
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-muted-foreground">Overview of all batches currently in various processing stages (e.g., drying, curing, trimming, packaging).</p>
