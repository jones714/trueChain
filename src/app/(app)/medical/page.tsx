...
import { ClipboardList, Users, HeartPulse, BarChart2, ShieldCheck, AlertTriangle, FileWarning, CalendarOff, PlusCircle, ClipboardEdit, Flag, MessageSquare } from "lucide-react";
  ...
  return (
    <PageContainer>
      <PageHeader 
        ...
        description="Oversee medical cannabis operations including patient management, specialized inventory, consultations, analytics, and compliance." 
      />
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        ...
        <Link href="/medical/patients" passHref>
          <Card className="hover:shadow-lg transition-shadow cursor-pointer rounded-lg xl:col-span-1">
            ...
            <CardContent>
              <CardDescription className="text-sm text-muted-foreground">
                Manage patient registry, conditions, recommendations, provider notes, state ID sync, and purchase/refill history.
              </CardDescription>
            </CardContent>
          </Card>
        </Link>
        <Link href="/medical/consultations" passHref>
         ...
         <Card className="rounded-lg xl:col-span-1"> {/* Quick Actions Panel */}
            ...
            <CardContent className="grid grid-cols-2 gap-2">
                ...
                <Button variant="outline" size="sm"><ClipboardEdit className="mr-1 h-3 w-3"/>Add Recommendation</Button>
      ...
      <div className="mt-6 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        <Card className="lg:col-span-2">
          <CardHeader>
            <CardTitle>Patient Overview Analytics</CardTitle>
            <CardDescription>Key metrics for your medical patient base.</CardDescription>
          </CardHeader>
          <CardContent className="grid gap-4 sm:grid-cols-2">
            <div className="p-3 bg-muted/50 rounded-lg">
             ...
             <div className="p-3 bg-muted/50 rounded-lg">
                ...
                <h4 className="font-semibold text-sm">Most Common Condition</h4>
                <p className="text-lg font-bold">Chronic Pain</p>
            </div>
            <div className="p-3 bg-muted/50 rounded-lg">
                <ClipboardList className="h-5 w-5 text-primary mb-1" />
                <h4 className="font-semibold text-sm">Most Dispensed Product Type</h4>
                <p className="text-lg font-bold">CBD Tinctures</p>
            </div>
            <div className="p-3 bg-muted/50 rounded-lg">
      ...
      <Card className="mt-6">
        ...
        <CardContent className="space-y-2 text-sm text-muted-foreground">
            <p><strong className="text-foreground">State ID Verification Tool:</strong> (Future API Hook) Scan or input MN medical ID for auto-validation against the state registry.</p>
            ...
            <p><strong className="text-foreground">Automated Reporting:</strong> Generate daily/weekly exports of patient activity, refills, and flagged conditions for regulatory bodies.</p>
        </CardContent>
      </Card>
    </PageContainer>
  );
